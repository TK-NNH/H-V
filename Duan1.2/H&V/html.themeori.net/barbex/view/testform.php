...
<body>
    <div class="container" style="margin-bottom:500px; margin-top:220px;">
                        ...
                        <form action="" class="formdatlich" method="POST" onsubmit="return validateForm()">
                            ...
                            <div class="col-sm-12 mb-30">
                                ...
                                <label for="thanhtoan">Thanh Toán :</label> <br>
                                    ...
                                    <input type="radio" name="COD"> VNPAY
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="contact__area-bottom-form-item">
                                    <button class="theme-banner-btn" type="submit" style="margin-left: 80px;" name="xacnhan">Xác Nhận<i class="far fa-angle-double-right"></i></button>
                                </div>
                            </div>
