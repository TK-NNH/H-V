        ...
        <div class="table-responsive">
            <form action="/vnpay_php/vnpay_create_payment.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="gia" name="gia" value="<?php echo isset($_POST['gia']) ? $_POST['gia'] : ''; ?>">
                    <input class="form-control" id="amount" name="amount" type="number" value="<?php echo isset($_POST['amount']) ? $_POST['amount'] : '10000'; ?>" />
                </div>
                ...
                <div class="form-group">
                    <label>Họ tên (*)</label>
                    <input class="form-control" id="txt_billing_fullname" name="txt_billing_fullname" type="text" value="NGUYEN VAN A" />
                </div>
                <div class="form-group">
                    <label>Email (*)</label>
                    <input class="form-control" id="txt_billing_email" name="txt_billing_email" type="text" value="A@vnpay.vn" />
                </div>
                <div class="form-group">
                    <label>Số điện thoại (*)</label>
                    <input class="form-control" id="txt_billing_mobile" name="txt_billing_mobile" type="text" value="0398455982" />
                </div>
                <div class="form-group">
                    <label>Địa chỉ (*)</label>
                    <input class="form-control" id="txt_billing_addr1" name="txt_billing_addr1" type="text" value="FPOLY HÀ NỘI" />
                </div>
                <div class="form-group">
